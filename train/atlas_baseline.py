...
from models import hmr, SMPL, Baseline
...
class AtlasBaselineTrainer(BaseTrainer):
    ...
    def init_fn(self):
        ...
        self.model = Baseline(self.options.num_fps,
    ...
    def train_step(self, input_batch, is_train=True):
        ...
        pred_cloth, _ = self.model(gt_abscloth0,None,torch.cat([gt_rot[:,9:],gt_betas],dim=1))

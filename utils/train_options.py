...
class TrainOptions():
    ...
    def __init__(self):
        ...
        req.add_argument('--train_module', required=True, help='Name of the network module to be trained')
        ...
        io.add_argument('--pretrained_atlas', default='logs_atlas/0425_2103/checkpoints/2020_04_28-12_26_09.pt', help='Load a pretrained checkpoint at the beginning training') 
        io.add_argument('--pretrained_hmr', default='logs_combined/0430_2051/checkpoints/2020_05_02-01_00_45.pt', help='Load a pretrained checkpoint at the beginning training') 

        train = self.parser.add_argument_group('Training Options')
        train.add_argument('--do_test', default=False, action='store_true', help='do test instead of train') 
        train.add_argument('--num_points', type=int, default=16384, help='Total number of training epochs')
        train.add_argument('--num_fps', type=int, default=256, help='Total number of training epochs')
        train.add_argument('--num_sample', type=int, default=128, help='Total number of training epochs')
        train.add_argument('--num_patches', type=int, default=1, help='Total number of training epochs')
        train.add_argument('--dim', type=int, default=3, help='6 if use normal else 3')
        train.add_argument('--seq_len', type=int, default=25, help='frame num when estimating mat')
        train.add_argument('--feature_mode', type=str, default='std', help='mat input feature mode')
        ...
        train.add_argument('--cloth_loss_weight', default=10., type=float, help='Weight of SMPL pose loss') 

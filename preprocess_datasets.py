...
from datasets.preprocess import synthetic_CH_extract, synthetic_M_extract, eval_mgn_extract
...
if __name__ == '__main__':
    ...
    if args.train_files:
        synthetic_M_extract(cfg.SYNTHETIC_ROOT, out_path, isTrain=True)
        # synthetic_CH_extract(cfg.SYNTHETIC_ROOT, out_path, isTrain=True)
    ...
    if args.eval_files:
        eval_mgn_extract(cfg.SYNTHETIC_ROOT, out_path, isTrain=False)
        # synthetic_M_extract(cfg.SYNTHETIC_ROOT, out_path, isTrain=False)
        # synthetic_CH_extract(cfg.SYNTHETIC_ROOT, out_path, isTrain=False)
